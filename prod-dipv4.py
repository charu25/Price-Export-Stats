...
list = [ x for x in os.listdir("/home/charu/price-export") if not x.startswith(".")]
list.sort()
...
for st in list:
    #st = sys.argv[1]
    df = pd.read_csv("/home/charu/price-export/"+st,sep="\t")
    f = open("/home/charu/price-export/"+st,"rb")
